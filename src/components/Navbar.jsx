...
export default function Navbar() {
  ...
  return (
    <>
      <Nav className='bg-transparent py-8 text-white sticky h-11 z-50 shadow-md top-0 left-0 w-full '>
        <div className="brand">
          <h1 className=" font-cinzel text-3xl text-white-500  ">Family Feast</h1>
